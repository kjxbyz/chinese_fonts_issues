...
///
/// Built on 2024-09-30 at 11:24 UTC
...
class _StringsZh implements Translations {
	...
	@override String get description => '您已按过此按钮很多次：';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'title': return 'Flutter Demo';
			case 'description': return 'You have pushed the button this many times:';
			default: return null;
		}
	}
}
...
extension on _StringsZh {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'title': return 'Flutter 示例';
			case 'description': return '您已按过此按钮很多次：';
			default: return null;
		}
	}
}
